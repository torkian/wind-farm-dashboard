...
import { TurbineMakeComparison } from './components/charts/TurbineMakeComparison';
            ...
            <TabPanel activeTab={activeTab} tabId="sites">
              <div className="mb-8">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                  <FullscreenWrapper title="Turbine Make Comparison">
                    <TurbineMakeComparison data={turbineMakeMetrics} />
                  </FullscreenWrapper>
